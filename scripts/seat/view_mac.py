"""
[VISUAL] Interactive MAC computation between dynamic modes and static reference shapes.

Opens a MAC-matrix figure and prints a ranking; asks interactively for the model,
rigid-body removal, subdomain averaging and weighting.  Not a pytest test — for
automated checks on compute_mac see tests/common/test_mac.py.

Run from anywhere:
    py -3 scripts/seat/view_mac.py
